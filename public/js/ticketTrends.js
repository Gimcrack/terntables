...
;(function (window, $) {
	...
	var _urlParams = function _urlParams(url) {
   ...
   */
		var process = function process(data) {
			...
			if (!!_get.ignore) {
				data = _(data).reject(function (o) {
					if (!o.Category) return false;
					return _get.ignore.split('|').some(function (cat) {
   ...
   */
		var chart1 = function chart1(data) {
			var today = new Date(),
			    ykeys = _(data).map(function (o) {
				return o.CreatedDate.getFullYear();
			}).uniq().value().sort(),
			    fn_counting = function fn_counting(o) {
				return o.CreatedDate.getFullYear();
			},
			    chartSettings = {
				parseTime: false,
				...
				.reject(function (o) {
					return o.length < 20 && data.length > 800;
				})
				...
				// group by month
				.groupBy(function (o) {
					return o.CreatedDate.getMonth();
				})
				// count by year
				.map(function (o, i) {
					return _(o).countBy(fn_counting).extend({ x: moment(new Date(2000, i, 1)).format("MMM") }).value();
				})
				// get the data
				.value(),
				xkey: 'x',
   ...
   */
		var chart4 = function chart4(data) {
			var fn_counting = function fn_counting(o) {
