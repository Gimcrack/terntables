...
class UsersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::create(['people_id' => 12, 'username' => 'jackadmin', 'email' => 'Jack.Horner@matsugov.us', 'password' => bcrypt('Matanuska1')])->groups()->attach([3,4]);
        User::create(['people_id' => 12, 'username' => 'jh03625', 'email' => 'Jack.Horner@matsugov.us', 'password' => bcrypt('Matanuska1')])->groups()->attach([3,4]);
